...
from Core.Error import InvalidKickTime, Unauthorized, NoQuotedMessage, UnknownError, NotEnoughtRights, BadRequest, NotFound404

bans = {"h12": 43200, "h10": 36000, "h8": 28800, "h4": 14400,
        "h2": 7200, "h1": 3600, "h0": 1800, "ever": 0}
...
class telegram_chatbot():
    ...
    def send_message(self, msg, chat_id, parse_mode=None):
        ...
        url = self.base + \
            "sendMessage?chat_id={}&text={}&parse_mode={}".format(
                chat_id, msg, parse_mode)
    ...
    def kick_chat_member(self, chat_id, user_id, until=None):
        ...
        url = self.base + \
            "kickChatMember?chat_id={}&user_id={}&until_date={}".format(
    ...
    def send_sticker(self, chat_id, sticker=None, repyl_to_message_id=None):
        ...
        url = self.base + "sendSticker?sticker={}&chat_id={}&reply_to_message_id={}".format(
            sticker, chat_id, repyl_to_message_id)
        value = requests.get(url)
        self.getError(value)
    ...
    def sendbootmsg(self, bootmsg):
        ...
        url = self.base + \
            "sendMessage?chat_id={}&text={}".format(self.masterID, bootmsg)
        requests.get(url)
    ...
    def getError(self, value):
        ...
        if value.status_code != 200:
            ...
            if value.status_code == 404:
                ...
                raise UnknownError(value.json()["description"])
